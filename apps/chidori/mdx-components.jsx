...
import { defineMDXConfig, useActiveTocItem, getIconForLanguageExtension, Icons } from "@rasenganjs/mdx";
...
export default defineMDXConfig({
  components: {
    ...
    Note,
    Pagination,
    Link: ({ className, ...props }) => <Link className={cn("text-foreground font-semibold underline underline-offset-4 cursor-pointer", className)} {...props} />
  },
