			...
			<div className='relative w-full p-2'>
				<div className='z-20 w-full flex flex-col items-center justify-center text-center px-4 pt-10'>
					...
					<p className='text-md text-center text-foreground max-w-[600px] mt-4'>
						<span className="font-bold">Chidori</span> is a documentation framework powered by <span className="font-bold">Rasengan.js</span> to build fast, elegant, and interactive documentation websites.
					</p>
					...
					<div className='relative w-full flex items-center justify-center mt-6 py-4'>
						...
						<div className='flex gap-4 mb-10'>
							...
							<Link to="https://github.com/rasengan-dev/chidori" target="_blank" className="font-semibold underline underline-offset-4">
								<Button variant={"outline"} className='rounded-full p-6! text-sm'>
									<Github />
