  ...
  return (
    ...
    >
      ...
      <main className="w-full flex lg:w-(--main-width) h-(--main-height) mt-[50px] overflow-hidden">
        ...
        <div className={cn('fixed top-[60px] z-30 left-0 w-64 h-full lg:hidden transition-all duration-300 ease-in-out', isOpen ? "" : "translate-x-[calc(-100%-20px)]")}>
        ...
        {
          isOpen && (
            <div className='lg:hidden bg-background/60 fixed top-0 left-0 w-full h-full' onClick={toggle}></div>
          )
        }
      </main>
    </section>
