import { _ as _$2 } from '@swc/helpers/cjs/_define_property.cjs';
import { _ as _$1 } from '@swc/helpers/cjs/_object_spread.cjs';
import { _ } from '@swc/helpers/cjs/_object_spread_props.cjs';
import { _ as _$3 } from '@swc/helpers/cjs/_object_without_properties.cjs';
import { TAG_PLACEHOLDER, TAG_REPLACEMENT, escapeFacets } from '../../lib/utils/escape-highlight.js';
 ...
 */ var connectRefinementList = function connectRefinementList(renderFn) {
    ...
    return function(widgetParams) {
        ...
        var formatItems = function formatItems(_0) {
            var label = _0.name, value = _0.escapedValue, item = _$3(_0, [
                "name",
                "escapedValue"
            ]);
            return _(_$1({}, item), {
            ...
            return function(renderOptions) {
                return function(query) {
                    ...
                    if (query === '' && lastItemsFromMainSearch) {
                        ...
                        renderFn(_(_$1({}, widget.getWidgetRenderState(_(_$1({}, renderOptions), {
                        ...
                        Math.min(getLimit(), 100), tags).then(function(results) {
                            ...
                            var normalizedFacetValues = transformItems(facetValues.map(function(_0) {
                                var escapedValue = _0.escapedValue, value = _0.value, item = _$3(_0, [
                                    "escapedValue",
                                    "value"
                                ]);
                                return _(_$1({}, item), {
        ...
        return {
            ...
            getRenderState: function getRenderState(renderState, renderOptions) {
                return _(_$1({}, renderState), {
                    refinementList: _(_$1({}, renderState.refinementList), _$2({}, attribute, this.getWidgetRenderState(renderOptions)))
                });
            },
            ...
            getWidgetUiState: function getWidgetUiState(uiState, param) {
                ...
                return removeEmptyRefinementsFromUiState(_(_$1({}, uiState), {
                    refinementList: _(_$1({}, uiState.refinementList), _$2({}, attribute, values))
                }), attribute);
            },
            getWidgetSearchParameters: function getWidgetSearchParameters(searchParameters, param) {
                ...
                if (!values) {
                    ...
                    return withMaxValuesPerFacet.setQueryParameters(_$2({}, key, _(_$1({}, withMaxValuesPerFacet[key]), _$2({}, attribute, []))));
                }
...
export { connectRefinementList as default };
