    ...
    return function(widgetParams) {
        ...
        function _prepareFacetValues(facetValues) {
            return facetValues.slice(0, getLimit()).map(function(_0) {
                var label = _0.name, value = _0.escapedValue, data = _0.data; _0.path; var subValue = _$4(_0, [
                    "name",
                    "escapedValue",
                    "data",
                    "path"
                ]);
                var item = _$1(_$2({}, subValue), {
                    value: value,
                    label: label,
                    data: null
                });
        ...
        return {
            ...
            getRenderState: function getRenderState(renderState, renderOptions) {
                return _$1(_$2({}, renderState), {
                    hierarchicalMenu: _$1(_$2({}, renderState.hierarchicalMenu), _$3({}, hierarchicalFacetName, this.getWidgetRenderState(renderOptions)))
                });
            },
            ...
            getWidgetSearchParameters: function getWidgetSearchParameters(searchParameters, param) {
                ...
                if (!values) {
                    return withMaxValuesPerFacet.setQueryParameters({
                        hierarchicalFacetsRefinements: _$1(_$2({}, withMaxValuesPerFacet.hierarchicalFacetsRefinements), _$3({}, hierarchicalFacetName, []))
                    });
                }
...
export { connectHierarchicalMenu as default };
