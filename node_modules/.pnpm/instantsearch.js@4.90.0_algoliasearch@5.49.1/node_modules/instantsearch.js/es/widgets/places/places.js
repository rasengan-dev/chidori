 ...
 */ var placesWidget = function placesWidget(widgetParams) {
    var _ref = widgetParams || {}, placesReference = _ref.placesReference, _ref_defaultPosition = _ref.defaultPosition, defaultPosition = _ref_defaultPosition === void 0 ? [] : _ref_defaultPosition, placesOptions = _(_ref, [
        "placesReference",
        "defaultPosition"
    ]);
    ...
    return {
        ...
        getWidgetUiState: function getWidgetUiState(uiState, param) {
            ...
            if (!hasPositionSet && !state.query) {
                uiState.places; var uiStateWithoutPlaces = _(uiState, [
                    "places"
                ]);
...
var places = deprecate(placesWidget);
