...
var analytics = function analytics(widgetParams) {
    ...
    var sendAnalytics = function sendAnalytics(analyticsState) {
        ...
        var serializedRefinements = serializeRefinements(_$1({}, analyticsState.state.disjunctiveFacetsRefinements, analyticsState.state.facetsRefinements, analyticsState.state.hierarchicalFacetsRefinements));
