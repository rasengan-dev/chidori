            ...
            getWidgetRenderState: function getWidgetRenderState(param) {
                ...
                connectorState.refine = function() {
                    connectorState.attributesToClear.forEach(function(param) {
                        ...
                        indexHelper.setState(clearRefinements.clearRefinements({
                            helper: indexHelper,
                ...
                connectorState.createURL = function() {
                    return createURL(mergeSearchParameters.mergeSearchParameters.apply(void 0, _to_consumable_array._(connectorState.attributesToClear.map(function(param) {
                        var indexHelper = param.helper, items = param.items;
                        return clearRefinements.clearRefinements({
                            helper: indexHelper,
                            attributesToClear: items
                        });
                    }))));
...
function getAttributesToClear(param) {
    ...
    return {
        ...
        items: transformItems(uniq.uniq(getRefinements.getRefinements(scopedResult.results, scopedResult.helper.state, includesQuery).map(function(refinement) {
