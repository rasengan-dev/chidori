    ...
    return function(widgetParams) {
        ...
        return {
            ...
            getWidgetUiState: function getWidgetUiState(uiState, param) {
                ...
                if (equal || equal === 0) {
                    return _object_spread_props._(_object_spread._({}, uiState), {
                        numericMenu: _object_spread_props._(_object_spread._({}, uiState.numericMenu), _define_property._({}, attribute, "".concat(values['='])))
                    });
                }
                var min = values['>='] && values['>='][0] || '';
                var max = values['<='] && values['<='][0] || '';
                return removeEmptyRefinementsFromUiState(_object_spread_props._(_object_spread._({}, uiState), {
                    numericMenu: _object_spread_props._(_object_spread._({}, uiState.numericMenu), _define_property._({}, attribute, "".concat(min, ":").concat(max)))
                }), attribute);
            },
            getWidgetSearchParameters: function getWidgetSearchParameters(searchParameters, param) {
                ...
                var _value_split_map = _sliced_to_array._(value.split(':').map(parseFloat), 2), min = _value_split_map[0], max = _value_split_map[1];
                var withMinRefinement = isFiniteNumber.isFiniteNumber(min) ? withoutRefinements.addNumericRefinement(attribute, '>=', min) : withoutRefinements;
                var withMaxRefinement = isFiniteNumber.isFiniteNumber(max) ? withMinRefinement.addNumericRefinement(attribute, '<=', max) : withMinRefinement;
                return withMaxRefinement;
            },
            getRenderState: function getRenderState(renderState, renderOptions) {
                return _object_spread_props._(_object_spread._({}, renderState), {
                    numericMenu: _object_spread_props._(_object_spread._({}, renderState.numericMenu), _define_property._({}, attribute, this.getWidgetRenderState(renderOptions)))
                });
            },
