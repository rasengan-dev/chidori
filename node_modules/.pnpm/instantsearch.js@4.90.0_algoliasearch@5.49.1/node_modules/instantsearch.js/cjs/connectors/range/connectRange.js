...
var isFiniteNumber = require('../../lib/utils/isFiniteNumber.js');
 ...
 */ var connectRange = function connectRange(renderFn) {
    ...
    return function(widgetParams) {
        ...
        if (isFiniteNumber.isFiniteNumber(minBound) && isFiniteNumber.isFiniteNumber(maxBound) && minBound > maxBound) {
        ...
        var getRefinedState = function getRefinedState(helper, currentRange, nextMin, nextMax) {
            ...
            var newNextMin;
            if (!isFiniteNumber.isFiniteNumber(minBound) && currentRangeMin === nextMinAsNumber) {
                newNextMin = undefined;
            } else if (isFiniteNumber.isFiniteNumber(minBound) && isResetMin) {
                newNextMin = minBound;
            } else {
                newNextMin = nextMinAsNumber;
            }
            var newNextMax;
            if (!isFiniteNumber.isFiniteNumber(maxBound) && currentRangeMax === nextMaxAsNumber) {
                newNextMax = undefined;
            } else if (isFiniteNumber.isFiniteNumber(maxBound) && isResetMax) {
                newNextMax = maxBound;
            } else {
                newNextMax = nextMaxAsNumber;
            }
            var isResetNewNextMin = newNextMin === undefined;
            var isGreaterThanCurrentRange = isFiniteNumber.isFiniteNumber(currentRangeMin) && currentRangeMin <= newNextMin;
            var isMinValid = isResetNewNextMin || isFiniteNumber.isFiniteNumber(newNextMin) && (!isFiniteNumber.isFiniteNumber(currentRangeMin) || isGreaterThanCurrentRange);
            var isResetNewNextMax = newNextMax === undefined;
            var isLowerThanRange = isFiniteNumber.isFiniteNumber(newNextMax) && currentRangeMax >= newNextMax;
            var isMaxValid = isResetNewNextMax || isFiniteNumber.isFiniteNumber(newNextMax) && (!isFiniteNumber.isFiniteNumber(currentRangeMax) || isLowerThanRange);
            var hasMinChange = min !== newNextMin;
            var hasMaxChange = max !== newNextMax;
            if ((hasMinChange || hasMaxChange) && isMinValid && isMaxValid) {
                resolvedState = resolvedState.removeNumericRefinement(attribute);
                if (isFiniteNumber.isFiniteNumber(newNextMin)) {
                    resolvedState = resolvedState.addNumericRefinement(attribute, '>=', newNextMin);
                }
                if (isFiniteNumber.isFiniteNumber(newNextMax)) {
        ...
        function _getCurrentRange(stats) {
            var min;
            if (isFiniteNumber.isFiniteNumber(minBound)) {
                min = minBound;
            } else if (isFiniteNumber.isFiniteNumber(stats.min)) {
                min = stats.min;
            } else {
                min = 0;
            }
            var max;
            if (isFiniteNumber.isFiniteNumber(maxBound)) {
                max = maxBound;
            } else if (isFiniteNumber.isFiniteNumber(stats.max)) {
                max = stats.max;
            } else {
                max = 0;
            }
        ...
        function _getCurrentRefinement(helper) {
            ...
            var min = isFiniteNumber.isFiniteNumber(minValue) ? minValue : -Infinity;
            var max = isFiniteNumber.isFiniteNumber(maxValue) ? maxValue : Infinity;
            return [
                min,
                max
            ];
        ...
        return {
            ...
            getWidgetRenderState: function getWidgetRenderState(param) {
                ...
                var facet = find.find(facetsFromResults, function(facetResult) {
            ...
            getWidgetSearchParameters: function getWidgetSearchParameters(searchParameters, param) {
                ...
                if (isFiniteNumber.isFiniteNumber(lowerBound) && (!isFiniteNumber.isFiniteNumber(minBound) || minBound < lowerBound)) {
                    widgetSearchParameters = widgetSearchParameters.removeNumericRefinement(attribute, '>=');
                    widgetSearchParameters = widgetSearchParameters.addNumericRefinement(attribute, '>=', lowerBound);
                }
                if (isFiniteNumber.isFiniteNumber(upperBound) && (!isFiniteNumber.isFiniteNumber(maxBound) || upperBound < maxBound)) {
                    widgetSearchParameters = widgetSearchParameters.removeNumericRefinement(attribute, '<=');
