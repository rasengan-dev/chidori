...
var hitsAbsolutePosition = require('../../lib/utils/hits-absolute-position.js');
var hitsQueryId = require('../../lib/utils/hits-query-id.js');
    ...
    return function(widgetParams) {
         ...
         */ var state = parent.getPreviousState() || existingState;
                ...
                if (!sendEvent) {
                    ...
                    bindEvent = createSendEventForHits.createBindEventForHits({
                        helper: helper,
                        widgetType: this.$$type,
                        instantSearchInstance: instantSearchInstance
                    });
                ...
                if (!results) {
                    ...
                    if (escapeHTML && results.hits.length > 0) {
                        results.hits = escapeHighlight.escapeHits(results.hits);
                    }
                    var hitsWithAbsolutePosition = hitsAbsolutePosition.addAbsolutePosition(results.hits, results.page, results.hitsPerPage);
                    var hitsWithAbsolutePositionAndQueryID = hitsQueryId.addQueryID(hitsWithAbsolutePosition, results.queryID);
          ...
          */ var hasDynamicWidgets = false;
                    walkIndex.walkIndex(instantSearchInstance.mainIndex, function(indexWidget) {
            ...
            dispose: function dispose(param) {
                ...
                return stateWithoutPage.setQueryParameters(Object.keys(escapeHighlight.TAG_PLACEHOLDER).reduce(function(acc, key) {
            ...
            getWidgetSearchParameters: function getWidgetSearchParameters(searchParameters, param) {
                ...
                if (escapeHTML) {
                    ...
                    widgetSearchParameters = searchParameters.setQueryParameters(escapeHighlight.TAG_PLACEHOLDER);
                }
