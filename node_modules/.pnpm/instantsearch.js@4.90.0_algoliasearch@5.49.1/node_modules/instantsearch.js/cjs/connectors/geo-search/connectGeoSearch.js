...
var geoSearch = require('../../lib/utils/geo-search.js');
 ...
 */ var connectGeoSearch = (function connectGeoSearch(renderFn) {
    ...
    return function(widgetParams) {
        ...
        var widgetState = {
            ...
            internalToggleRefineOnMapMove: noop.noop,
            internalSetMapMoveSinceLastRefine: noop.noop
        };
        var getPositionFromState = function getPositionFromState(state) {
            return state.aroundLatLng ? geoSearch.aroundLatLngToPosition(state.aroundLatLng) : undefined;
        };
        var getCurrentRefinementFromState = function getCurrentRefinementFromState(state) {
            return state.insideBoundingBox && geoSearch.insideBoundingBoxToBoundingBox(state.insideBoundingBox);
        };
        ...
        var createInternalToggleRefinementOnMapMove = function createInternalToggleRefinementOnMapMove(renderOptions, // false positive eslint because of generics
        ...
        var createInternalSetMapMoveSinceLastRefine = function createInternalSetMapMoveSinceLastRefine(renderOptions, // false positive eslint because of generics
        // eslint-disable-next-line no-shadow
        render) {
            return function() {
        ...
        return {
            ...
            init: function init(initArgs) {
                ...
                widgetState.internalToggleRefineOnMapMove = createInternalToggleRefinementOnMapMove(initArgs, noop.noop);
                widgetState.internalSetMapMoveSinceLastRefine = createInternalSetMapMoveSinceLastRefine(initArgs, noop.noop);
                renderFn(_object_spread_props._(_object_spread._({}, this.getWidgetRenderState(initArgs)), {
