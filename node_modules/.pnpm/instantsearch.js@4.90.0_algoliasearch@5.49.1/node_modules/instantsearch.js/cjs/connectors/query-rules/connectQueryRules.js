...
function getRuleContextsFromTrackedFilters(param) {
    ...
    var ruleContexts = Object.keys(trackedFilters).reduce(function(facets, facetName) {
        var facetRefinements = getRefinements.getRefinements(helper.lastResults || {}, sharedHelperState, true).filter(function(refinement) {
...
function applyRuleContexts(event) {
    ...
    if (!isEqual.isEqual(previousRuleContexts, ruleContexts)) {
...
var connectQueryRules = function connectQueryRules(render) {
    var unmount = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : noop.noop;
    checkRendering.checkRendering(render, withUsage());
