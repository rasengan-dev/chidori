...
var connectFilterSuggestions = function connectFilterSuggestions(renderFn) {
    ...
    return function(widgetParams) {
        ...
        var fetchSuggestions = function fetchSuggestions(results, renderOptions) {
            ...
            var currentRefinements = searchHelper ? getRefinements.getRefinements(results, searchHelper.state).map(function(refinement) {
                return {
...
exports.default = connectFilterSuggestions;
