...
var createSendEventForFacet = require('../../lib/utils/createSendEventForFacet.js');
            ...
            return function(renderOptions) {
                return function(query) {
                    ...
                    if (query === '' && lastItemsFromMainSearch) {
                        ...
                        var tags = {
                            highlightPreTag: escapeFacetValues ? escapeHighlight.TAG_PLACEHOLDER.highlightPreTag : escapeHighlight.TAG_REPLACEMENT.highlightPreTag,
                            highlightPostTag: escapeFacetValues ? escapeHighlight.TAG_PLACEHOLDER.highlightPostTag : escapeHighlight.TAG_REPLACEMENT.highlightPostTag
                        };
                        ...
                        Math.min(getLimit(), 100), tags).then(function(results) {
                            var facetValues = escapeFacetValues ? escapeHighlight.escapeFacets(results.facetHits) : results.facetHits;
        ...
        return {
            ...
            getWidgetRenderState: function getWidgetRenderState(renderOptions) {
                ...
                if (!sendEvent || !triggerRefine || !searchForFacetValues) {
                    sendEvent = createSendEventForFacet.createSendEventForFacet({
                        instantSearchInstance: instantSearchInstance,
                        helper: helper,
                        attribute: attribute,
