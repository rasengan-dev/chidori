...
function getRefinementsItems(param) {
    ...
    var items = getRefinements.getRefinements(results, helper.state, includesQuery).map(normalizeRefinement).filter(filterFunction);
    return items.reduce(function(allItems, currentItem) {
        return _to_consumable_array._(allItems.filter(function(item) {
