...
var renderTemplate = require('../../lib/templating/renderTemplate.js');
...
var RawHtml = /*#__PURE__*/ function(Component) {
    ...
    function RawHtml() {
        ...
        var _this;
        _this = _call_super._(this, RawHtml, arguments), _define_property._(_this, "ref", preact.createRef()), _define_property._(_this, "nodes", []);
        return _this;
    }
    ...
    _create_class._(Template, [
        {
            ...
            value: function shouldComponentUpdate(nextProps) {
                return !isEqual.isEqual(this.props.data, nextProps.data) || this.props.templateKey !== nextProps.templateKey || !isEqual.isEqual(this.props.rootProps, nextProps.rootProps);
            }
        },
        {
            key: "render",
            value: function render() {
                var RootTagName = this.props.rootTagName === 'fragment' ? preact.Fragment : this.props.rootTagName;
                var useCustomCompileOptions = this.props.useCustomCompileOptions[this.props.templateKey];
                var compileOptions = useCustomCompileOptions ? this.props.templatesConfig.compileOptions : {};
                var content = renderTemplate.renderTemplate({
                ...
                if ((typeof content === "undefined" ? "undefined" : _type_of._(content)) === 'object') {
                    return /*#__PURE__*/ preact.h(RootTagName, this.props.rootProps, content);
                }
                // This is to handle Hogan templates with Fragment as rootTagName
                if (RootTagName === preact.Fragment) {
                    return /*#__PURE__*/ preact.h(RawHtml, {
                        content: content,
                        key: Math.random()
                    });
                }
                return /*#__PURE__*/ preact.h(RootTagName, _object_spread_props._(_object_spread._({}, this.props.rootProps), {
