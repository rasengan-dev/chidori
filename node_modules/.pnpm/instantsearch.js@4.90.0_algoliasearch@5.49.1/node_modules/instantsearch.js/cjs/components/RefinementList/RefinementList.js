...
var RefinementListItem = require('./RefinementListItem.js');
var isSpecialClick = require('../../lib/utils/isSpecialClick.js');
var isEqual = require('../../lib/utils/isEqual.js');
...
var RefinementList = /*#__PURE__*/ function(Component) {
    ...
    function RefinementList() {
        ...
        var _this;
        _this = _call_super._(this, RefinementList, arguments), _define_property._(_this, "listRef", preact.createRef()), _define_property._(_this, "searchBox", preact.createRef()), _define_property._(_this, "lastRefinedValue", undefined), _define_property._(_this, "_generateFacetItem", function(facetValue) {
            var subItems;
            if (isHierarchicalMenuItem(facetValue) && Array.isArray(facetValue.data) && facetValue.data.length > 0) {
                ...
                subItems = /*#__PURE__*/ preact.h(RefinementList, _object_spread_props._(_object_spread._({}, _this.props), {
        ...
        _define_property._(_this, "handleItemClick", function(param) {
            ...
            if (isSpecialClick.isSpecialClick(originalEvent)) {
    ...
    _create_class._(RefinementList, [
        {
            ...
            value: function shouldComponentUpdate(nextProps) {
                var areFacetValuesDifferent = !isEqual.isEqual(this.props.facetValues, nextProps.facetValues);
   ...
   */ function componentDidUpdate() {
        ...
        },
        {
            ...
            value: function render() {
                var _this = this;
                var showMoreButtonClassName = instantsearchUiComponents.cx(this.props.cssClasses.showMore, !(this.props.showMore === true && this.props.canToggleShowMore) && this.props.cssClasses.disabledShowMore);
                var showMoreButton = this.props.showMore === true && /*#__PURE__*/ preact.h(Template.default, _object_spread_props._(_object_spread._({}, this.props.templateProps), {
                ...
                var searchBox = this.props.searchFacetValues && /*#__PURE__*/ preact.h("div", {
                    className: this.props.cssClasses.searchBox
                }, /*#__PURE__*/ preact.h(SearchBox.default, {
                    ref: this.searchBox,
                ...
                var facetValues = this.props.facetValues && this.props.facetValues.length > 0 && /*#__PURE__*/ preact.h("ul", {
                    ref: this.listRef,
                    className: this.props.cssClasses.list
                }, this.props.facetValues.map(this._generateFacetItem, this));
                var noResults = this.props.searchFacetValues && this.props.isFromSearch && (!this.props.facetValues || this.props.facetValues.length === 0) && /*#__PURE__*/ preact.h(Template.default, _object_spread_props._(_object_spread._({}, this.props.templateProps), {
                    templateKey: "searchableNoResults",
                    rootProps: {
                        className: this.props.cssClasses.noResults
                    }
                }));
                var rootClassName = instantsearchUiComponents.cx(this.props.cssClasses.root, (!this.props.facetValues || this.props.facetValues.length === 0) && this.props.cssClasses.noRefinementRoot, this.props.className);
