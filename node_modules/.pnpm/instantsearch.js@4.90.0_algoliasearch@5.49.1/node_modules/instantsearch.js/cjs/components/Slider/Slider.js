...
var Rheostat = require('./Rheostat.js');
var range = require('../../lib/utils/range.js');
    ...
    function Slider() {
        ...
        _this = _call_super._(this, Slider, arguments), _define_property._(_this, "handleChange", function(param) {
            ...
            return function(props) {
                ...
                var className = instantsearchUiComponents.cx(props.className, props['data-handle-key'] === 0 && 'rheostat-handle-lower', props['data-handle-key'] === 1 && 'rheostat-handle-upper');
                var ariaLabel = props['data-handle-key'] === 0 ? 'Minimum Filter Handle' : 'Maximum Filter Handle';
                return /*#__PURE__*/ preact.h("div", _object_spread_props._(_object_spread._({}, props), {
                    className: className,
                    "aria-label": ariaLabel
                }), tooltips && /*#__PURE__*/ preact.h("div", {
    ...
    _create_class._(Slider, [
        ...
        },
        {
            ...
            function computeDefaultPitPoints(param) {
                ...
                var pitPoints = [
                    min
                ].concat(_to_consumable_array._(range.range({
                    end: steps - 1
                }).map(function(step) {
        ...
        },
        {
            ...
            function computeSnapPoints(param) {
                ...
                return _to_consumable_array._(range.range({
                    start: min,
                    end: max,
                    step: step
                })).concat([
        ...
        },
        {
            ...
            value: function render() {
                ...
                return /*#__PURE__*/ preact.h("div", {
                    className: instantsearchUiComponents.cx(cssClasses.root, this.isDisabled && cssClasses.disabledRoot)
                }, /*#__PURE__*/ preact.h(Rheostat.default, {
                    handle: this.createHandleComponent(tooltips),
                    onChange: this.handleChange,
                    min: min,
                    max: max,
                    pitComponent: Pit.default,
                    pitPoints: pitPoints,
                    snap: true,
