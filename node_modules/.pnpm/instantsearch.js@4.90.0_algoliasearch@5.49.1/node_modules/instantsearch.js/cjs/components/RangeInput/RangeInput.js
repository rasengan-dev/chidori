    ...
    _create_class._(RangeInput, [
        ...
        },
        {
            ...
            value: function render() {
                ...
                var rootClassNames = instantsearchUiComponents.cx(cssClasses.root, !hasRefinements && cssClasses.noRefinement);
                return /*#__PURE__*/ preact.h("div", {
                    className: rootClassNames
                }, /*#__PURE__*/ preact.h("form", {
                    className: cssClasses.form,
                    onSubmit: this.onSubmit
                }, /*#__PURE__*/ preact.h("label", {
                    className: cssClasses.label
                }, /*#__PURE__*/ preact.h("input", {
                    className: instantsearchUiComponents.cx(cssClasses.input, cssClasses.inputMin),
                    type: "number",
                    min: min,
                    max: max,
                    step: step,
                    ...
                    disabled: isDisabled
                })), /*#__PURE__*/ preact.h(Template.default, _object_spread_props._(_object_spread._({}, templateProps), {
                    ...
                    className: instantsearchUiComponents.cx(cssClasses.input, cssClasses.inputMax),
                    type: "number",
                    min: min,
                    max: max,
                    step: step,
