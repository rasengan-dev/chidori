...
var escapeFacetValue = require('./escapeFacetValue.js');
...
function getRefinement(state, type, attribute, name) {
    ...
    var res = {
        ...
        attribute: attribute,
        name: name,
        escapedValue: escapeFacetValue.escapeFacetValue(name)
    };
    var facet = find.find(resultsFacets, function(resultsFacet) {
        return resultsFacet.name === attribute;
    });
    var count;
    if (type === 'hierarchical') {
        var _loop = function(i) {
            facet = facet && facet.data && find.find(Object.keys(facet.data).map(getFacetRefinement(facet.data)), function(refinement) {
...
function getRefinements(_results, state) {
    ...
    Object.keys(disjunctiveFacetsRefinements).forEach(function(attribute) {
        ...
        refinementNames.forEach(function(refinementName) {
            ...
            escapeFacetValue.unescapeFacetValue(refinementName), results.disjunctiveFacets));
        });
    });
