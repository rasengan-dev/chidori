...
var streamParser = require('./stream-parser.js');
    ...
    _create_class._(HttpChatTransport, [
        {
            ...
            value: function sendMessages(param) {
                ...
                return Promise.all([
                    utils.resolveValue(this.credentials),
                    utils.resolveValue(this.headers),
                    utils.resolveValue(this.body)
                ]).then(function(param) {
    ...
    _create_class._(DefaultChatTransport, [
        {
            ...
            value: function processResponseStream(stream) {
                return streamParser.parseJsonEventStream(stream);
            }
        }
    ]);
...
exports.DefaultChatTransport = DefaultChatTransport;
exports.HttpChatTransport = HttpChatTransport;
