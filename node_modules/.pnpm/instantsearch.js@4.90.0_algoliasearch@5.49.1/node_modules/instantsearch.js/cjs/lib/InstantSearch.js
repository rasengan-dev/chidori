...
var createInsightsMiddleware = require('../middlewares/createInsightsMiddleware.js');
var createMetadataMiddleware = require('../middlewares/createMetadataMiddleware.js');
var createRouterMiddleware = require('../middlewares/createRouterMiddleware.js');
var index = require('../widgets/index/index.js');
var createHelpers = require('./createHelpers.js');
var version = require('./version.js');
var hydrateSearchClient = require('./utils/hydrateSearchClient.js');
var hydrateRecommendCache = require('./utils/hydrateRecommendCache.js');
var setIndexHelperState = require('./utils/setIndexHelperState.js');
var documentation = require('./utils/documentation.js');
var defer = require('./utils/defer.js');
var noop = require('./utils/noop.js');
var isIndexWidget = require('./utils/isIndexWidget.js');
 ...
 */ var InstantSearch = /*#__PURE__*/ function(EventEmitter) {
   ...
   */ _define_property._(_this, "error", undefined), _define_property._(_this, "scheduleSearch", defer.defer(function() {
            if (_this.started) {
                _this.mainHelper.search();
            }
        })), _define_property._(_this, "scheduleRender", defer.defer(function() {
            ...
            _this.emit('render');
        })), _define_property._(_this, "onInternalStateChange", defer.defer(function() {
        ...
        if (typeof searchClient.addAlgoliaAgent === 'function') {
            searchClient.addAlgoliaAgent("instantsearch.js (".concat(version.default, ")"));
        }
        ...
        _this.sendEventToInsights = noop.noop;
        if (routing) {
            var routerOptions = typeof routing === 'boolean' ? {} : routing;
            routerOptions.$$internal = true;
            _this.use(createRouterMiddleware.createRouterMiddleware(routerOptions));
        }
        ...
        if (insights) {
            ...
            _this.use(createInsightsMiddleware.createInsightsMiddleware(insightsOptions));
        }
        if (createMetadataMiddleware.isMetadataEnabled()) {
            _this.use(createMetadataMiddleware.createMetadataMiddleware({
                $$internal: true
            }));
        }
        return _this;
   ...
   */ function use() {
                ...
                var newMiddlewareList = middleware.map(function(fn) {
                    var newMiddleware = _object_spread._({
                        ...
                        subscribe: noop.noop,
                        started: noop.noop,
                        unsubscribe: noop.noop,
                        onStateChange: noop.noop
                    }, fn({
                        instantSearchInstance: _this
                    }));
   ...
   */ function addWidgets(widgets) {
                ...
                if (this.compositionID && widgets.some(function(w) {
                    return !Array.isArray(w) && isIndexWidget.isIndexWidget(w) && !w._isolated;
                })) {
   ...
   */ function start() {
                ...
                if (this._initialResults) {
                    hydrateSearchClient.hydrateSearchClient(this.client, this._initialResults);
                    hydrateRecommendCache.hydrateRecommendCache(this.mainHelper, this._initialResults);
                    var originalScheduleSearch = this.scheduleSearch;
                    // We don't schedule a first search when initial results are provided
                    // because we already have the results to render. This skips the initial
                    // network request on the browser on `start`.
                    this.scheduleSearch = defer.defer(noop.noop);
                ...
                if (typeof this._insights === 'undefined') {
                    mainHelper.derivedHelpers[0].once('result', function() {
                        ...
                        if (hasAutomaticInsights) {
                            _this.use(createInsightsMiddleware.createInsightsMiddleware({
                                $$internal: true,
                                $$automatic: true
                            }));
                        }
                ...
                if (this.onStateChange && callOnStateChange) {
                    this.onStateChange({
                        ...
                        setUiState: function setUiState(finalUiState) {
                            setIndexHelperState.setIndexHelperState(typeof finalUiState === 'function' ? finalUiState(nextUiState) : finalUiState, _this.mainIndex);
                            _this.scheduleSearch();
                            _this.onInternalStateChange();
                        }
                    });
                } else {
                    setIndexHelperState.setIndexHelperState(nextUiState, this.mainIndex);
                    this.scheduleSearch();
