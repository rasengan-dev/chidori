...
function createInfiniteHitsSessionStorageCache() {
    ...
    return {
        read: function read(param) {
            ...
            var sessionStorage = safelyRunOnBrowser.safelyRunOnBrowser(function(param) {
            ...
            try {
                ...
                return cache && isEqual.isEqual(cache.state, getStateWithoutPage(state)) ? cache.hits : null;
            } catch (error) {
