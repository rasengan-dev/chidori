...
var qs = require('qs');
var safelyRunOnBrowser = require('../utils/safelyRunOnBrowser.js');
...
var BrowserHistory = /*#__PURE__*/ function() {
    function BrowserHistory(param) {
        ...
        _class_call_check._(this, BrowserHistory);
        _define_property._(this, "$$type", 'ais.browser');
        /**
   * Transforms a UI state into a title for the page.
   */ _define_property._(this, "windowTitle", void 0);
        /**
   ...
   *
   * @default 400
   */ _define_property._(this, "writeDelay", void 0);
        /**
   * Creates a full URL based on the route state.
   * The storage adaptor maps all syncable keys to the query string of the URL.
   */ _define_property._(this, "_createURL", void 0);
        /**
   * Parses the URL into a route state.
   * It should be symmetrical to `createURL`.
   */ _define_property._(this, "parseURL", void 0);
        /**
   * Returns the location to store in the history.
   * @default () => window.location
   */ _define_property._(this, "getLocation", void 0);
        _define_property._(this, "writeTimer", void 0);
        _define_property._(this, "_onPopState", void 0);
        /**
   * Indicates if last action was back/forward in the browser.
   */ _define_property._(this, "inPopState", false);
        /**
   * Indicates whether the history router is disposed or not.
   */ _define_property._(this, "isDisposed", false);
        /**
   * Indicates the window.history.length before the last call to
   * window.history.pushState (called in `write`).
   * It allows to determine if a `pushState` has been triggered elsewhere,
   * and thus to prevent the `write` method from calling `pushState`.
   */ _define_property._(this, "latestAcknowledgedHistory", 0);
        _define_property._(this, "_start", void 0);
        _define_property._(this, "_dispose", void 0);
        _define_property._(this, "_push", void 0);
        _define_property._(this, "_cleanUrlOnDispose", void 0);
        ...
        safelyRunOnBrowser.safelyRunOnBrowser(function(param) {
    ...
    _create_class._(BrowserHistory, [
        {
            key: "read",
            value: /**
   ...
   */ function dispose() {
        ...
        },
        {
            ...
            value: function shouldWrite(url) {
                var _this = this;
                return safelyRunOnBrowser.safelyRunOnBrowser(function(param) {
                    var window1 = param.window;
