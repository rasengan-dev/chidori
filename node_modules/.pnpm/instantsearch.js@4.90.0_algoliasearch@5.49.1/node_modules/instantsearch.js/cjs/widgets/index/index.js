...
var addWidgetId = require('../../lib/utils/addWidgetId.js');
var isIndexWidget = require('../../lib/utils/isIndexWidget.js');
var defer = require('../../lib/utils/defer.js');
var resolveSearchParameters = require('../../lib/utils/resolveSearchParameters.js');
var renderArgs = require('../../lib/utils/render-args.js');
var documentation = require('../../lib/utils/documentation.js');
var mergeSearchParameters = require('../../lib/utils/mergeSearchParameters.js');
...
function getLocalWidgetsUiState(widgets, widgetStateOptions) {
    ...
    return widgets.reduce(function(uiState, widget) {
        if (isIndexWidget.isIndexWidget(widget)) {
            return uiState;
        }
...
function getLocalWidgetsSearchParameters(widgets, widgetSearchParametersOptions) {
    ...
    return widgets.reduce(function(state, widget) {
        if (!widget.getWidgetSearchParameters || isIndexWidget.isIndexWidget(widget)) {
            return state;
        }
...
function getLocalWidgetsRecommendParameters(widgets, widgetRecommendParametersOptions) {
    ...
    return widgets.reduce(function(state, widget) {
        if (!isIndexWidget.isIndexWidget(widget) && widget.dependsOn === 'recommend' && widget.getWidgetParameters) {
            return widget.getWidgetParameters(state, rest);
        }
        return state;
    }, initialRecommendParameters);
...
function resetPageFromWidgets(widgets) {
    var indexWidgets = widgets.filter(isIndexWidget.isIndexWidget);
...
var index = function index(widgetParams) {
    ...
    return {
        ...
        getResultsForWidget: function getResultsForWidget(widget) {
            if (widget.dependsOn !== 'recommend' || isIndexWidget.isIndexWidget(widget) || widget.$$id === undefined) {
        ...
        scheduleLocalSearch: defer.defer(function() {
            if (isolated) {
        ...
        addWidgets: function addWidgets(widgets) {
            ...
            flatWidgets.forEach(function(widget) {
                ...
                addWidgetId.addWidgetId(widget);
            });
            ...
            if (localInstantSearchInstance && Boolean(flatWidgets.length)) {
                ...
                flatWidgets.forEach(function(widget) {
                    if (widget.getRenderState) {
                        var renderState = widget.getRenderState(localInstantSearchInstance.renderState[_this.getIndexId()] || {}, renderArgs.createInitArgs(localInstantSearchInstance, _this, localInstantSearchInstance._initialUiState));
                        storeRenderState({
                ...
                flatWidgets.forEach(function(widget) {
                    if (widget.init) {
                        widget.init(renderArgs.createInitArgs(localInstantSearchInstance, _this, localInstantSearchInstance._initialUiState));
                    }
                });
                if (isolated) {
        ...
        removeWidgets: function removeWidgets(widgets) {
            ...
            if (localInstantSearchInstance && Boolean(flatWidgets.length)) {
                var _flatWidgets_reduce = flatWidgets.reduce(function(states, widget) {
                    ...
                    if (_instanceof._(next, algoliasearchHelper.RecommendParameters)) {
        ...
        init: function init(param) {
            ...
            helper.searchForFacetValues = function(facetName, facetValue, maxFacetHits, userState) {
                var state = mergeSearchParameters.mergeSearchParameters.apply(void 0, [
                    mainHelper.state
                ].concat(_to_consumable_array._(resolveSearchParameters.resolveSearchParameters(_this)))).setQueryParameters(userState);
            ...
            derivedHelper = derivingHelper.derive(function() {
                return mergeSearchParameters.mergeSearchParameters.apply(void 0, [
                    mainHelper.state
                ].concat(_to_consumable_array._(resolveSearchParameters.resolveSearchParameters(_this))));
            }, function() {
            ...
            localWidgets.forEach(function(widget) {
                if (widget.getRenderState) {
                    var renderState = widget.getRenderState(instantSearchInstance.renderState[_this.getIndexId()] || {}, renderArgs.createInitArgs(instantSearchInstance, _this, uiState));
                    storeRenderState({
                        renderState: renderState,
                        instantSearchInstance: instantSearchInstance,
                        parent: _this
            ...
            localWidgets.forEach(function(widget) {
                if (widget.init) {
                    widget.init(renderArgs.createInitArgs(instantSearchInstance, _this, uiState));
                }
            });
        ...
        render: function render(param) {
            ...
            widgetsToRender.forEach(function(widget) {
                if (widget.getRenderState) {
                    var renderState = widget.getRenderState(instantSearchInstance.renderState[_this.getIndexId()] || {}, renderArgs.createRenderArgs(instantSearchInstance, _this, widget));
                    storeRenderState({
                        renderState: renderState,
                        instantSearchInstance: instantSearchInstance,
                        parent: _this
            ...
            widgetsToRender.forEach(function(widget) {
                ...
                if (widget.render) {
                    widget.render(renderArgs.createRenderArgs(instantSearchInstance, _this, widget));
                }
            });
        },
        ...
        getWidgetUiState: function getWidgetUiState(uiState) {
            return localWidgets.filter(isIndexWidget.isIndexWidget).filter(function(w) {
                return !w._isolated;
