...
var connectLookingSimilar = require('../../connectors/looking-similar/connectLookingSimilar.js');
...
var LookingSimilar = instantsearchUiComponents.createLookingSimilarComponent({
...
function createRenderer(param) {
    ...
    return function(param, isFirstRendering) {
        ...
        preact.render(/*#__PURE__*/ preact.h(LookingSimilar, {
            items: items,
...
var lookingSimilar = (function lookingSimilar(widgetParams) {
    ...
    var makeWidget = connectLookingSimilar.default(specializedRenderer, function() {
