...
var connectFrequentlyBoughtTogether = require('../../connectors/frequently-bought-together/connectFrequentlyBoughtTogether.js');
...
var FrequentlyBoughtTogether = instantsearchUiComponents.createFrequentlyBoughtTogetherComponent({
...
var renderer = function renderer(param) {
    ...
    return function(param, isFirstRendering) {
        ...
        preact.render(/*#__PURE__*/ preact.h(FrequentlyBoughtTogether, {
            items: items,
...
var frequentlyBoughtTogether = (function frequentlyBoughtTogether(widgetParams) {
    ...
    var makeWidget = connectFrequentlyBoughtTogether.default(specializedRenderer, function() {
