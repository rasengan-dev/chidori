...
var connectTrendingItems = require('../../connectors/trending-items/connectTrendingItems.js');
...
var TrendingItems = instantsearchUiComponents.createTrendingItemsComponent({
...
function createRenderer(param) {
    ...
    return function renderer(param, isFirstRendering) {
        ...
        preact.render(/*#__PURE__*/ preact.h(TrendingItems, {
            items: items,
            sendEvent: sendEvent,
...
var trendingItems = (function trendingItems(widgetParams) {
    ...
    var makeWidget = connectTrendingItems.default(specializedRenderer, function() {
    ...
    return _object_spread_props._(_object_spread._({}, makeWidget(_object_spread_props._(_object_spread._({}, facetParameters), {
        limit: limit,
