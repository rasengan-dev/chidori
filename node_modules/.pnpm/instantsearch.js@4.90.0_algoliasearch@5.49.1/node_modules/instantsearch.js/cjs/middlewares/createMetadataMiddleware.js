...
function extractWidgetPayload(widgets, instantSearchInstance, payload) {
    var initOptions = renderArgs.createInitArgs(instantSearchInstance, instantSearchInstance.mainIndex, instantSearchInstance._initialUiState);
    ...
    return function(param) {
        ...
        return {
            ...
            subscribe: function subscribe() {
                ...
                setTimeout(function() {
                    payload.ua = getAlgoliaAgent.getAlgoliaAgent(instantSearchInstance.client);
