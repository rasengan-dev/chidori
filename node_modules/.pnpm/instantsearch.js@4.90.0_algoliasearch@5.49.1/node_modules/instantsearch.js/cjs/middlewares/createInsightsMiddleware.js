...
var getInsightsAnonymousUserToken = require('../helpers/get-insights-anonymous-user-token.js');
var safelyRunOnBrowser = require('../lib/utils/safelyRunOnBrowser.js');
...
function createInsightsMiddleware() {
    ...
    var insightsClient = potentialInsightsClient || noop.noop;
    return function(param) {
        ...
        if (Array.isArray(queue)) {
            ...
            ref = _sliced_to_array._([
                ...
                var _ref = _sliced_to_array._(find.find(queue.slice().reverse(), function(param) {
        ...
        return {
            ...
            started: function started() {
                ...
                if (Array.isArray(queueAtStart)) {
                    ...
                    ref = _sliced_to_array._([
                        ...
                        var _ref = _sliced_to_array._(find.find(queueAtStart.slice().reverse(), function(param) {
                            var _param = _sliced_to_array._(param, 1), method = _param[0];
                            return method === key;
                        }) || [], 2), value = _ref[1];
                        return value;
                ...
                var anonymousTokenFromInsights = getInsightsAnonymousUserToken.getInsightsAnonymousUserTokenInternal();
                if (anonymousTokenFromInsights) {
                    ...
                    var token = "anonymous-".concat(uuid.createUUID());
                ...
                if (isModernInsightsClient(insightsClient)) {
                    insightsClientWithLocalCredentials = function insightsClientWithLocalCredentials(method, payload) {
                        var _getAppIdAndApiKey = _sliced_to_array._(getAppIdAndApiKey.getAppIdAndApiKey(instantSearchInstance.client), 2), latestAppId = _getAppIdAndApiKey[0], latestApiKey = _getAppIdAndApiKey[1];
                        var extraParams = {
                            headers: {
            ...
            unsubscribe: function unsubscribe() {
                ...
                instantSearchInstance.sendEventToInsights = noop.noop;
