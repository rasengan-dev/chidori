...
export interface ViteConfig extends Omit<Vite.UserConfig, 'plugins' | 'environments' | 'appType' | 'resolve' | 'cacheDir' | 'envPrefix' | 'builder' | 'ssr' | 'server' | 'build' | 'ssrEmitAssets' | 'root' | 'base'> {
    plugins?: Vite.Plugin[];
    resolve?: {
        symbole?: string;
        alias?: Array<{
