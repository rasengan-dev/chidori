import { _ as _$1 } from '@swc/helpers/cjs/_instanceof.cjs';
...
function createStickToBottom(param) {
    ...
    return function useStickToBottom() {
        ...
        var _useState = _(useState(false), 2), escapedFromLock = _useState[0], updateEscapedFromLock = _useState[1];
        var _useState1 = _(useState(options.initial !== false), 2), isAtBottom = _useState1[0], updateIsAtBottom = _useState1[1];
        var _useState2 = _(useState(false), 2), isNearBottom = _useState2[0], setIsNearBottom = _useState2[1];
        ...
        var scrollToBottom = useCallback(function() {
            ...
            if (_$1(scrollOptions.duration, Promise)) {
        ...
        useEffect(function() {
            ...
            var resizeObserver = new ResizeObserver(function(param) {
                var _param = _(param, 1), entry = _param[0];
...
function mergeAnimations() {
    ...
    animations.forEach(function(animation) {
        ...
        if ((typeof animation === "undefined" ? "undefined" : _$3(animation)) !== 'object') {
            return;
        }
        instant = false;
