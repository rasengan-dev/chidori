...
function createAutocompleteDetachedSearchButtonComponent(param) {
    ...
    return function AutocompleteDetachedSearchButton(userProps) {
        ...
        return /*#__PURE__*/ createElement("div", {
            className: cx.cx('ais-AutocompleteDetachedSearchButton', classNames.detachedSearchButton),
            onClick: onClick,
            ...
            className: cx.cx('ais-AutocompleteDetachedSearchButtonIcon', classNames.detachedSearchButtonIcon)
        }, /*#__PURE__*/ createElement(icons.SearchIcon, {
            createElement: createElement
        })), /*#__PURE__*/ createElement("div", {
            className: cx.cx('ais-AutocompleteDetachedSearchButtonPlaceholder', classNames.detachedSearchButtonPlaceholder),
            hidden: Boolean(query)
        }, placeholder), /*#__PURE__*/ createElement("div", {
            className: cx.cx('ais-AutocompleteDetachedSearchButtonQuery', classNames.detachedSearchButtonQuery)
        }, query), query && onClear && /*#__PURE__*/ createElement("button", {
            type: "reset",
            className: cx.cx('ais-AutocompleteDetachedSearchButtonClear', classNames.detachedSearchButtonClear),
            title: translations.detachedClearButtonTitle,
            onClick: function onClick(event) {
                event.stopPropagation();
                onClear();
            }
        }, /*#__PURE__*/ createElement(icons.ClearIcon, {
            createElement: createElement
        })));
    };
}
