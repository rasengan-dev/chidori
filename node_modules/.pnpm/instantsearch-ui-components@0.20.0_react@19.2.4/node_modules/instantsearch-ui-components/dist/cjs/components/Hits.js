...
function createDefaultBannerComponent(param) {
    ...
    return function DefaultBanner(param) {
        ...
        return /*#__PURE__*/ createElement("aside", {
            className: cx.cx('ais-Hits-banner', classNames.bannerRoot)
        }, banner.link ? /*#__PURE__*/ createElement("a", {
            className: cx.cx('ais-Hits-banner-link', classNames.bannerLink),
            href: banner.link.url,
            target: banner.link.target
        }, /*#__PURE__*/ createElement("img", {
            className: cx.cx('ais-Hits-banner-image', classNames.bannerImage),
...
function createHitsComponent(param) {
    ...
    return function Hits(userProps) {
        ...
        return /*#__PURE__*/ createElement("div", _object_spread_props._(_object_spread._({}, props), {
            className: cx.cx('ais-Hits', classNames.root, hits.length === 0 && cx.cx('ais-Hits--empty', classNames.emptyRoot), props.className)
            ...
            className: cx.cx('ais-Hits-list', classNames.list)
        }, hits.map(function(hit, index) {
            return /*#__PURE__*/ createElement(ItemComponent, {
                key: hit.objectID,
                hit: hit,
                index: index,
                className: cx.cx('ais-Hits-item', classNames.item),
