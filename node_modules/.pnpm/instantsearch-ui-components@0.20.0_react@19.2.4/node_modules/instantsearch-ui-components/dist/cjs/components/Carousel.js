...
function createCarouselComponent(param) {
    ...
    return function Carousel(userProps) {
        ...
        var cssClasses = {
            root: cx.cx('ais-Carousel', classNames.root),
            list: cx.cx('ais-Carousel-list', classNames.list),
            item: cx.cx('ais-Carousel-item', classNames.item),
            navigation: cx.cx('ais-Carousel-navigation', classNames.navigation),
            navigationNext: cx.cx('ais-Carousel-navigation--next', classNames.navigationNext),
            navigationPrevious: cx.cx('ais-Carousel-navigation--previous', classNames.navigationPrevious)
        };
        function scrollLeft() {
            if (listRef.current) {
        ...
        return /*#__PURE__*/ createElement("div", _object_spread_props._(_object_spread._({}, props), {
            className: cx.cx(cssClasses.root)
            ...
            className: cx.cx(cssClasses.navigation, cssClasses.navigationPrevious),
            ...
            className: cx.cx(cssClasses.list),
            ref: listRef,
            tabIndex: 0,
            ...
            return /*#__PURE__*/ createElement("li", {
                key: item.objectID,
                className: cx.cx(cssClasses.item),
            ...
            "aria-controls": carouselIdRef.current,
            className: cx.cx(cssClasses.navigation, cssClasses.navigationNext),
            onClick: function onClick(event) {
                event.preventDefault();
                scrollRight();
            }
