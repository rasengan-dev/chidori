...
function createChatPromptComponent(param) {
    ...
    return function ChatPrompt(userProps) {
        ...
        var cssClasses = {
            root: cx.cx('ais-ChatPrompt', classNames.root),
            header: cx.cx('ais-ChatPrompt-header', classNames.header),
            body: cx.cx('ais-ChatPrompt-body', classNames.body),
            textarea: cx.cx('ais-ChatPrompt-textarea ais-Scrollbar', disabled && 'ais-ChatPrompt-textarea--disabled', classNames.textarea),
            actions: cx.cx('ais-ChatPrompt-actions', classNames.actions, disabled && 'ais-ChatPrompt-actions--disabled'),
            submit: cx.cx('ais-ChatPrompt-submit', classNames.submit),
            footer: cx.cx('ais-ChatPrompt-footer', classNames.footer)
        };
        ...
        var submitIcon = canStop ? /*#__PURE__*/ createElement(icons.StopIcon, {
            createElement: createElement
        }) : /*#__PURE__*/ createElement(icons.ArrowUpIcon, {
            createElement: createElement
        });
        return /*#__PURE__*/ createElement("form", {
            ...
            className: cx.cx(cssClasses.textarea),
            value: value,
        ...
        }, /*#__PURE__*/ createElement(Button$1, {
            type: "submit",
            variant: "primary",
            size: "sm",
            iconOnly: true,
            className: cx.cx(cssClasses.submit),
