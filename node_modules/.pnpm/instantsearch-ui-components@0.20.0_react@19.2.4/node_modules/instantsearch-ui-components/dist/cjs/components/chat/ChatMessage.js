...
var startsWith = require('../../lib/utils/startsWith.js');
...
function createChatMessageComponent(param) {
    ...
    var Button$1 = Button.createButtonComponent({
    ...
    return function ChatMessage(userProps) {
        ...
        var cssClasses = {
            root: cx.cx('ais-ChatMessage', "ais-ChatMessage--".concat(side), "ais-ChatMessage--".concat(variant), autoHideActions && 'ais-ChatMessage--auto-hide-actions', classNames.root),
            container: cx.cx('ais-ChatMessage-container', classNames.container),
            leading: cx.cx('ais-ChatMessage-leading', classNames.leading),
            content: cx.cx('ais-ChatMessage-content', classNames.content),
            message: cx.cx('ais-ChatMessage-message', classNames.message),
            actions: cx.cx('ais-ChatMessage-actions', classNames.actions),
            footer: cx.cx('ais-ChatMessage-footer', classNames.footer)
        };
        function renderMessagePart(part, index) {
            ...
            if (part.type === 'text') {
                var markdown = markdownToJsx.compiler(part.text, {
                    createElement: createElement,
            ...
            if (startsWith.startsWith(part.type, 'tool-')) {
                var toolName = part.type.replace('tool-', '');
                var tool = tools[toolName];
                // Compatibility shim with Algolia MCP Server search tool
                if (!tool && startsWith.startsWith(toolName, "".concat(SearchIndexToolType, "_"))) {
        ...
        return /*#__PURE__*/ createElement("article", _object_spread_props._(_object_spread._({}, props), {
            ...
            }, action.icon ? /*#__PURE__*/ createElement(action.icon, null) : /*#__PURE__*/ createElement(icons.MenuIcon, {
                createElement: createElement
            }));
        })), FooterComponent && /*#__PURE__*/ createElement("div", {
            className: cx.cx(cssClasses.footer)
