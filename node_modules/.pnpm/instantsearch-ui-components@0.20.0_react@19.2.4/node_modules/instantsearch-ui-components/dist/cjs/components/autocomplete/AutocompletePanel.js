...
function createAutocompletePanelComponent(param) {
    ...
    return function AutocompletePanel(userProps) {
        ...
        return /*#__PURE__*/ createElement("div", _object_spread_props._(_object_spread._({}, props), {
            "aria-hidden": hidden,
            className: cx.cx('ais-AutocompletePanel', !hidden && 'ais-AutocompletePanel--open', classNames.root, props.className),
            ...
            className: cx.cx('ais-AutocompletePanelLayout', classNames.layout)
        }, children));
    };
}
