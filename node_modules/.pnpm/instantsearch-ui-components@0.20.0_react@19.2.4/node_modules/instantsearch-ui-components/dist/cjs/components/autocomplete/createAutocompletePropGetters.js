...
function createAutocompletePropGetters(param) {
    ...
    return function usePropGetters(param) {
        ...
        var _useState = _sliced_to_array._(useState(false), 2), isOpen = _useState[0], setIsOpen = _useState[1];
